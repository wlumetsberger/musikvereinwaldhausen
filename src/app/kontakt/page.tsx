      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="relative mb-16">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Kontakt & Mitglied werden</h1>
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="max-w-4xl mx-auto bg-white/80 dark:bg-black/40 rounded-3xl shadow-2xl p-10 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Kontaktformular */}
            <div>
              <h2 className="text-3xl font-bold mb-4 text-[var(--primary)]">Kontaktformular</h2>
              <form
                className="space-y-6"
              ...
              >
                <div>
                  <label className="block text-sm font-semibold mb-1 text-gray-700 dark:text-gray-200">Ihr Name</label>
                  <input
                    type="text"
                    name="Name"
                    required
                ...
                <div>
                  <label className="block text-sm font-semibold mb-1 text-gray-700 dark:text-gray-200">Ihre E-Mail</label>
                  <input
                    type="email"
                    name="E-Mail"
                    required
                ...
                <div>
                  <label className="block text-sm font-semibold mb-1 text-gray-700 dark:text-gray-200">Nachricht</label>
                  <textarea
                    name="Nachricht"
                    required
                    rows={5}
            ...
            <div className="flex flex-col items-start justify-center space-y-6">
              <h3 className="text-2xl font-bold text-[var(--secondary)] mb-2">Adresse & Kontakt</h3>
